...
the effects replicate across two held-out shape query types at 20 seeds and in a larger three-object
world, and are robust to description order, synthetic mix, and---for readability---a dimension-matched
control.
