...
accuracy (at $f{=}0.2$: $\{0.93, 0.67, 0.57, 0.34\}$; Spearman $\rho{=}1.0$ at both $f{=}0.1$ and
$0.2$, $n{=}10$). Few-shot binding is thus a graded function of readability at fixed dimension, not
an artifact of one code---readability, not input dimension, drives the deficit.
