...
oracle $\gg$ shared low-readability code, replicated on a fresh held-out query type (the symbolic route
...
tracks readability rather than input dimension. A capacity sweep of the MLP decoder
